...
def _state_file(provider: str) -> Path:
    ...
    The app is taken from the APP_CODE environment variable so multiple apps
    ...
    only ever writes playstore.json). When APP_CODE is unset the legacy
